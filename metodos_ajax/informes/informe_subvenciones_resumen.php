...
if($resultado_consulta = $Conexion->query("call procedimiento_informe(".$anio.",1,".$subvencion.",".$colegio.")")){
 ...
 function generar_informe_excel(){
   window.open("./metodos_ajax/informes/archivo_subvenciones_excel_resumen.php?txt_anio='.$anio.'&select_subvencion='.$subvencion.'&select_colegio='.$colegio.'", "Diseño Web", "width=500, height=100")
 }
 </script>
